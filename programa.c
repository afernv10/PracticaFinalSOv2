...
/************************************************************
// Realizado parte obligatoria y parte opcional 1 (cambio dinámico de atletas)
************************************************************/
...
int main(int argc, char *argv[]) {
	...
	char atMax[100];
	sprintf(atMax, "El número de atletas máximos en cola al inicio es %d.", numeroAtletas);
