...
void *accionesAtleta (void *idAtleta ) { /*Acciones de los atletas en el circuito */
	...
	while(atletas[posicion].ha_competido != 2 && atletas[posicion].ha_competido == 0) {
		...
		if(atletas[posicion].ha_competido != 2 && atletas[posicion].ha_competido == 0){	
	...
	while(atletas[posicion].ha_competido==1 && atletas[posicion].ha_competido !=0 && atletas[posicion].ha_competido !=2) {
...
void *accionesTarima(void *tarima_asignada){
	...
	while(TRUE){
		...
		while(ocupada == 0){
				...
				for (i = 0; i < ATLETAS_MAX; i++){
					...
					if(atletas[i].idAtleta != 0 && atletas[i].ha_competido == 0){
						...
						if(atletas[i].idAtleta < variable){
							...
							/*if(atletas[i].tarima_asignada == 1){
								atletas[i].tarima_asignada = 2;
								printf("cambio a 2\n");
							} else if( atletas[i].tarima_asignada == 2){
								atletas[i].tarima_asignada = 1;
								printf("cambio a 1\n");
							}*/
							atletas[posAtleta].ha_competido = 1;
							posAtleta = i;
			...
			if(ocupada == 0){
				sleep(1);
				//printf("holi despues de dos for\n");
			}
